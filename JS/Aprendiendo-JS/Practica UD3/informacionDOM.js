...
document.addEventListener("DOMContentLoaded", function(e){
    ...
    // Los 20 primeros caracteres del primer párrafo.
    document.querySelector("#mostrarInformacion").innerHTML+= "Los 20 primeros caracteres del primer párrafo. " + document.querySelector("p").innerText.slice(0, 21);
    document.querySelector("#mostrarInformacion").innerHTML+= "<br>"
    // El número de enlaces.
    ...
    document.querySelector("#mostrarInformacion").innerHTML+= "<br>"
    // El número de enlaces hijos de un “p” que tenga color red
    document.querySelector("#mostrarInformacion").innerHTML+= "El número de enlaces hijos de un “p” que tenga color red " + document.querySelector('p[style="color: red;"]').querySelectorAll("a").length;
    document.querySelector("#mostrarInformacion").innerHTML+= "<br>"
